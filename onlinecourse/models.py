...
class Question(models.Model):
    ...
    question_point = models.IntegerField(default=1) # question grade/mark
    ...
    def is_get_score(self, selected_ids):
        ...
        selected_answer = self.choice_set.filter(id__in=selected_ids).count()
        if set(all_answers) == set(selected_answer):
            return True
        else:
            return False
...
class Choice(models.Model):
    ...
    choice_text = models.TextField() # question text
